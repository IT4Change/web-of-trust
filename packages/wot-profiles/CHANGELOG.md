...
## [0.1.3](https://github.com/IT4Change/web-of-trust/compare/profiles-v0.1.2...profiles-v0.1.3) (2026-04-27)
...
* DiscoveryAdapter — 7th adapter for public profile discovery ([10db340](https://github.com/IT4Change/web-of-trust/commit/10db3402d39cf52f26b0f7bcdf035df58b0a7264))
* Profile Sync (Phase 1) + Symmetric Crypto (Phase 2) + Evolu cross-device sync ([75fd173](https://github.com/IT4Change/web-of-trust/commit/75fd17336cbf4837f199fea3fb9aa1dbf568d148))
