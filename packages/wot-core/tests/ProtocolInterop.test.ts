...
describe('WoT protocol interop vectors', () => {
  ...
  it('rejects schema-invalid log-entry payloads inside signed JWS objects', async () => {
    ...
    const invalidPayloads = [
      ...
      ['non-v4 deviceId UUID', { ...validPayload, deviceId: '550e8400-e29b-51d4-a716-446655440000' }],
      ['non-v4 docId UUID', { ...validPayload, docId: '7f3a2b10-4c5d-5e6f-8a7b-9c0d1e2f3a4b' }],
      ['uppercase deviceId UUID', { ...validPayload, deviceId: validPayload.deviceId.toUpperCase() }],
      ['uppercase docId UUID', { ...validPayload, docId: validPayload.docId.toUpperCase() }],
