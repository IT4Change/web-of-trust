...
export { hasSecureSelfLeave, hasNamedRoots, isValidNamedRootName, assertValidNamedRootName, toJsonValue, defineRootKey, assertValidNamedRootKey, freezeDeep } from './application/spaces/replication-capabilities'
