...
export { hasMembershipActivity, hasSecureSelfLeave, hasDeterministicPrivateSpace, hasDurableTransact, hasNamedRoots, isValidNamedRootName, assertValidNamedRootName, toJsonValue, defineRootKey } from '../application/spaces/replication-capabilities'
export * from './spaces'
