...
export { hasMembershipActivity, hasSecureSelfLeave, hasDeterministicPrivateSpace, hasDurableTransact, hasNamedRoots, isValidNamedRootName, assertValidNamedRootName, toJsonValue, defineRootKey, assertValidNamedRootKey, freezeDeep } from '../application/spaces/replication-capabilities'
export * from './spaces'
