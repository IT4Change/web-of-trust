...
export { hasMembershipActivity, hasSecureSelfLeave, hasDeterministicPrivateSpace, hasDurableTransact, hasNamedRoots, isValidNamedRootName, assertValidNamedRootName } from '../application/spaces/replication-capabilities'
export * from './spaces'
