...
export { hasMembershipActivity, hasSecureSelfLeave, hasDeterministicPrivateSpace, hasDurableTransact, hasNamedRoots } from '../application/spaces/replication-capabilities'
export * from './spaces'
