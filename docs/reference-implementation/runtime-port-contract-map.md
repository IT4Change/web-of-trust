...
Envelope/capability authority | Resolved durch Sync 003 (Capability JWS) und Sync 005. Legacy-`crypto/capabilities.ts`+`envelope-auth.ts` werden in Phase 1.A komplett entfernt; Authority liegt in `protocol/sync/`. | `03-wot-sync/003-*.md` Z.218-238
