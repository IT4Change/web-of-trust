      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
            <a href="#how-it-works" className="flex items-center justify-center gap-3 text-muted-foreground hover:text-primary transition-colors">
              <div className="w-10 h-10 rounded-full bg-primary/10 flex items-center justify-center">
                <Users size={20} className="text-primary" />
              </div>
              <span className="font-medium">{t.hero.features.verification}</span>
            </a>
            <Link to="/architecture#server-protection" className="flex items-center justify-center gap-3 text-muted-foreground hover:text-secondary transition-colors">
              <div className="w-10 h-10 rounded-full bg-secondary/10 flex items-center justify-center">
                <Shield size={20} className="text-secondary" />
              </div>
              <span className="font-medium">{t.hero.features.encrypted}</span>
            </Link>
            <Link to="/architecture#local-first" className="flex items-center justify-center gap-3 text-muted-foreground hover:text-warning transition-colors">
